    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">New Orders</h1>
                ...
                <div class="me-4 d-flex">
                    <div class="d-flex align-items-center position-relative my-1 me-3">
                        ...
                        <input type="text" data-kt-table-filter="search"
                            class="form-control form-control-solid w-250px ps-14" placeholder="Search New Orders" />
                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Customer Deatails</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e('ORD' . str_pad(number_format($row->id + 100000, 0, '', ''), 6, '0', STR_PAD_LEFT)); ?>

                                </td>
                                <td>
                                    <?php echo e(date('Y-m-d', strtotime($row->ordered_date))); ?>

                                </td>
                                <td>
                                    LKR <?php echo e($row->net_total); ?>

                                </td>
                                <td>
                                    Customer ID : #CUST<?php echo e($row->customer->id); ?> <br>
                                    Customer Name : <?php echo e($row->customer->first_name.' '.$row->customer->last_name); ?> <br>
                                    Contact No : <?php echo e($row->customer->contact_no_personal_country_code); ?> <?php echo e($row->customer->contact_no_personal); ?><br>
                                    
                                </td>
                                <td class="text-start">
                                    <?php if($row->customer->status == 1): ?>
                                ...
                                <td>
                                    <form action="<?php echo e(route('admin.master.new_orders.delete', $row->id)); ?>" method="POST"
                                        class="float-end">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                    ...
                                    <form action="<?php echo e(route('admin.new_orders.status', [$row->id, $row->status])); ?>"
                                    ...
                                    <a href="<?php echo e(route('page.admin.orders.single', $row->id)); ?>"
...
<script src="<?php echo e(asset('assets/js/custom/table/table.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/admin/orders/new_orders.blade.php ENDPATH**/ ?>