    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Processing Orders</h1>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo e(route('admin.master.processing_orders.delete', $row->id)); ?>"
                                    ...
                                    <form
                                        action="<?php echo e(route('admin.processing_orders.status', [$row->id, $row->status])); ?>"
                                        method="POST" class="float-end">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/admin/orders/processing_orders.blade.php ENDPATH**/ ?>