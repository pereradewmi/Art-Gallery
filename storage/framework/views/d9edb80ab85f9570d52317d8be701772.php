                ...
                <div class="me-4 d-flex">
                    <div class="d-flex align-items-center position-relative my-1 me-3">
                        ...
                        <input type="text" data-kt-table-filter="search"
                            class="form-control form-control-solid w-250px ps-14" placeholder="Search Author" />
                    </div>
                    <a href="<?php echo e(route('page.admin.master.master_author.create')); ?>" class="btn btn-primary my-1">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/admin/master-master_author-delete/<?php echo e($row->id); ?>" method="POST"
                                        class="float-end">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                    ...
                                    <form action="/admin/master-master_author-status/<?php echo e($row->id); ?>/<?php echo e($row->status); ?>"
                                    ...
                                    <a href="/admin/master-master_author-edit/<?php echo e($row->id); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/admin/master-data/master_author/index.blade.php ENDPATH**/ ?>