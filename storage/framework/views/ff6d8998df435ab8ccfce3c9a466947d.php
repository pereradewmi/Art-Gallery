                                ...
                                <div class="card-title w-100">
                                    ...
                                    <form class="d-flex justify-content-between w-100" data-kt-table-toolbar="base">
                                        ...
                                        <input  type="date"
                                            ...
                                            name="start_date" required value="<?php echo e($start_date ?? ''); ?>">

                                        <input  type="date"
                                            class="form-control form-control-solid me-2" placeholder="Enter Publication Date"
                                            name="end_date" required value="<?php echo e($end_date ?? ''); ?>">

                                        <button type="submit" class="btn btn-primary" href="<?php echo e(route('page.admin.users.create')); ?>" style="width:200px !important;">
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        <?php $__currentLoopData = $table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo e(date('d M ,Y', strtotime($row->ordered_date))); ?>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
                                    ...
                                    <div class="d-flex text-center flex-column text-white pt-8">
                                        ...
                                        <span class="fw-bolder fs-2x pt-1">LKR <?php echo e($revenue); ?></span>
                                    </div>
                                    <!--end::Balance-->
                                </div>
                                <!--end::Header-->
                                ...
                                <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="fw-bolder fs-5 text-gray-800 pe-1">LKR <?php echo e($sales); ?></div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            ...
                                            <!--begin::Label-->
                                            <div class="d-flex align-items-center">
                                                <div class="fw-bolder fs-5 text-gray-800 pe-1">LKR <?php echo e($couriers_charges); ?></div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            ...
                                            <!--begin::Label-->
                                            <div class="d-flex align-items-center">
                                                <div class="fw-bolder fs-5 text-gray-800 pe-1">LKR <?php echo e($processing_fee); ?></div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Description-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            ...
                                            <!--begin::Label-->
                                            <div class="d-flex align-items-center">
                                                <div class="fw-bolder fs-5 text-gray-800 pe-1"><?php echo e($order_count); ?></div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Description-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/admin/reports/orders.blade.php ENDPATH**/ ?>