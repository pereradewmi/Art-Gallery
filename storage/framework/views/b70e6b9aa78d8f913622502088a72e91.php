...
<head>
	<base href="">
	<title>Heena Publishers (Pvt) Ltd. | <?php echo $__env->yieldContent('title'); ?></title>
	<meta charset="utf-8" />
	...
	<link rel="shortcut icon" href="<?php echo e(asset('assets/new-favicon.ico')); ?>" />
	<!--begin::Fonts-->
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<!--begin::Header-->
				<?php echo $__env->make('layouts.admin-components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<!--end::Header-->
...
</html><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/layouts/admin.blade.php ENDPATH**/ ?>