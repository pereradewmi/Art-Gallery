	...
	<div class="d-flex flex-column flex-root">
			...
			<div
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<a href="<?php echo e(route('login')); ?>" class="mb-12">
						<img alt="Logo" src="<?php echo e(asset('assets/new-logo.png')); ?>" class="h-100px" />
					</a>
...
</html><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/layouts/auth.blade.php ENDPATH**/ ?>