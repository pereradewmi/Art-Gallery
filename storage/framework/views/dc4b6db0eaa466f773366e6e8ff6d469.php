			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<img class="wow slideInRight center-block img-responsive" data-wow-delay="0ms"
						data-wow-duration="3000ms" alt="" src="<?php echo e(asset('img/about-us/book.jpg')); ?>">
				</div>
			...
			<div class="row clearfix">
				...
				<div class="col-md-4 col-sm-12 col-xs-12">
					<figure class="wow bounceInUp  animated" data-wow-delay="0ms" data-wow-duration="3500ms">
						<img class="center-block" src="<?php echo e(asset('img/about-us/potra.jpg')); ?>" width="85%">
					</figure>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12 nopadding hidden-sm">
					<div class="call-to-action-img-section-right">
						<img src="<?php echo e(asset('img/about-us/car-in-red.png')); ?>" class="wow slideInLeft img-responsive"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dewmi\OneDrive\Desktop\Art-Gallery\resources\views/about-us.blade.php ENDPATH**/ ?>