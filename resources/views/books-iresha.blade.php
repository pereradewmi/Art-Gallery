							...
							<div class="posts-masonry">
								...
								<div class="col-md-4 col-xs-12 col-sm-4">
									...
									<div class="white category-grid-box-1">
										...
										<div class="image"> <img alt="Carspot"
												src="{{ asset($book->cover_image_path) }}" class="img-responsive">
										</div>
										...
										<div class="ad-info-1">
											<ul>
												...
												<li><a href="{{ route('add.to.cart', $book->id) }}"
														class="btn save-ad"><i class="fa fa-shopping-cart"></i></a></li>
												<li><a class="btn save-ad"><i class="fa fa-eye"></i></a></li>
											</ul>
										</div>
									</div>
