        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Vehicle</h1>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        <form  class="form" action="{{route('admin.vehicle.update')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row mb-6">
                                  {{-- row 1  --}}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{$vehicle->stock_no}}" readonly type="text" class="form-control form-control-solid" placeholder="Enter Stock Number" name="stock_no">
                                            @error('stock_no')
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->title }}" type="text" class="form-control form-control-solid" placeholder="Enter Title" name="title">
                                            @error('title')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->fob_price }}" type="number" class="form-control form-control-solid" placeholder="FOB Price" name="fob_price">
                                            @error('fob_price')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                  ...
                                  {{-- row 2  --}}
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-8xnb">
                                        ...
                                        <select name="status" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-10-z8y1" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option value="0"  @if($vehicle->status==0) {{'selected'}} @endif data-select2-id="select2-data-1-2">Comming soon</option>
                                            <option value="1" @if($vehicle->status==1) {{'selected'}} @endif data-select2-id="select2-data-1-3">Now on sale</option>
                                        </select>
                                        @error('status')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-asda">
                                        ...
                                        <select name="type" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-asda" tabindex="-1" aria-hidden="true">
                                            ...
                                            @foreach ($data->type as $row)
                                                <option @if($vehicle->type==$row->id) {{'selected'}} @endif value="{{$row->id}}" data-select2-id="select2-data-2-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('type')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-3">
                                        ...
                                        <select name="body_type" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-3" tabindex="-1" aria-hidden="true">
                                            ...
                                            @foreach ($data->body_type as $row)
                                                <option @if($vehicle->body_type==$row->id) {{'selected'}} @endif value="{{$row->id}}" data-select2-id="select2-data-3-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('body_type')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-6 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-31">
                                        ...
                                        <select name="make" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-31" tabindex="-1" aria-hidden="true">
                                            @foreach ($data->make as $row)
                                                <option  @if($vehicle->make==$row->id) {{'selected'}} @endif  value="{{$row->id}}" data-select2-id="select2-data-31-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('make')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-6 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-5">
                                        ...
                                        <select name="model" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-5" tabindex="-1" aria-hidden="true">
                                            @foreach ($data->model as $row)
                                                <option @if($vehicle->model==$row->id) {{'selected'}} @endif  value="{{$row->id}}" data-select2-id="select2-data-5-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('model')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-13">
                                        ...
                                        <select name="transmission" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-13" tabindex="-1" aria-hidden="true">
                                            @foreach ($data->transmission as $row)
                                                <option @if($vehicle->transmission==$row->id) {{'selected'}} @endif  value="{{$row->id}}" data-select2-id="select2-data-13-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('transmission')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-14">
                                        ...
                                        <select name="fuel" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-14" tabindex="-1" aria-hidden="true">
                                            @foreach ($data->fuel as $row)
                                                <option @if($vehicle->fuel==$row->id) {{'selected'}} @endif value="{{$row->id}}" data-select2-id="select2-data-14-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('fuel')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-24">
                                        ...
                                        <select name="exterior_color" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-24" tabindex="-1" aria-hidden="true">
                                            @foreach ($data->exterior_color as $row)
                                                <option @if($vehicle->exterior_color==$row->id) {{'selected'}} @endif value="{{$row->id}}" data-select2-id="select2-data-24-{{$row->id}}">{{$row->name}}</option>
                                            @endforeach
                                        </select>
                                  ...
                                  {{-- row 5  --}}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->chassis_no }}" name="chassis_no" type="text" class="form-control form-control-solid" placeholder="Enter Chassis Number">
                                            @error('chassis_no')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-6">
                                        ...
                                        <select name="drive" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-6" tabindex="-1" aria-hidden="true">
                                            <option @if($vehicle->drive==0) {{'selected'}} @endif value="0" data-select2-id="select2-data-6-2">Right hand</option>
                                            <option @if($vehicle->drive==1) {{'selected'}} @endif value="1" data-select2-id="select2-data-6-3">left hand</option>
                                        </select>
                                        @error('drive')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->mileage}}" name="mileage" type="number" class="form-control form-control-solid" placeholder="Enter Mileage">
                                            @error('mileage')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                  ...
                                  {{-- row 6  --}}
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input maxlength="4"  value="{{ $vehicle->manufacture_year}}" name="manufacture_year" type="text" class="form-control form-control-solid" placeholder="Enter Manufacture Year">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->seating_capacity }}" name="seating_capacity" type="text" class="form-control form-control-solid" placeholder="Enter Seating Capacity">
                                    ...
                                    <div class="col-lg-4 mb-8 fv-row fv-plugins-icon-container" data-select2-id="select2-data-71-7">
                                        ...
                                        <select name="twd_fwd" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member"  data-select2-id="select2-data-71-7" tabindex="-1" aria-hidden="true">
                                            <option @if($vehicle->twd_fwd==0) {{'selected'}} @endif value="0" data-select2-id="select2-data-7-2">2WD</option>
                                            <option @if($vehicle->twd_fwd==1) {{'selected'}} @endif value="1" data-select2-id="select2-data-7-3">4WD</option>
                                        </select>
                                        @error('twd_fwd')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                  ...
                                  {{-- end row 7  --}}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->doors }}" name="doors" type="number" class="form-control form-control-solid" placeholder="Enter number of doors" >
                                            @error('doors')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->length }}" name="length" type="number" class="form-control form-control-solid" placeholder="Enter Length (cm)" >
                                            @error('length')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->width }}" name="width" type="number" class="form-control form-control-solid" placeholder="Enter Width (cm)">
                                            @error('width')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                  ...
                                  {{-- row 8  --}}
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->height }}" name="height" type="number" class="form-control form-control-solid" placeholder="Enter Height (cm)">
                                            @error('height')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->weight }}" name="weight" type="number" class="form-control form-control-solid" placeholder="Enter Weight (Kg)">
                                            @error('weight')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                            ...
                                            <input value="{{ $vehicle->engine_capacity }}" name="engine_capacity" type="number" class="form-control form-control-solid" placeholder="Enter Engine Capacity (CC)">
                                  ...
                                  {{-- end row 8  --}}
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <textarea name="remark"  class="form-control form-control-solid" rows="3" name="target_details" placeholder="Type Target Details">{{ $vehicle->remark }}</textarea>
                                        @error('remark')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="form-group">
                                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(/assets/media/avatars/vehicle.png)">
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$vehicle->vehicleImages[$i-1]->image_path ?? '/assets/media/avatars/vehicle.png'}})"></div>
                                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                                        <i class="bi bi-pencil-fill fs-7"></i>
                                                        <input type="file" name="main_image_{{$i}}"  accept=".png, .jpg, .jpeg" />
                                                        <input type="hidden" name="main_image_url_{{$i}}"  accept=".png, .jpg, .jpeg" value="{{$vehicle->vehicleImages[$i-1]->image_path ?? ''}}" />
                                                    </label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label close-label">
                                                                {{-- @dd($vehicle->vehicleOptions[$key]->option_id); --}}
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="accessory{{ $accessory->id }}" name="option[]"
                                                                    value="{{ $accessory->id}}"
                                                                    @isset($vehicle->vehicleOptions)
                                                                        @foreach ($vehicle->vehicleOptions as $row)
                                                                            @if ($row->option_id == $accessory->id)
                                                                                @checked(true)
                                                                            @endif
                                                                        @endforeach
                                                                    @endisset
