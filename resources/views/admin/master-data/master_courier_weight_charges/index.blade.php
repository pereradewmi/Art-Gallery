                ...
                <div class="me-4 d-flex">
                    <div class="d-flex align-items-center position-relative my-1 me-3">
                        ...
                        <input type="text" data-kt-table-filter="search"
                            ...
                            placeholder="Search Courier Weight Charge" />
                    </div>
                    <a href="{{ route('page.admin.master.courier_weight_charge.create') }}"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Min Weight</th>
                                <th class="min-w-125px">Max Weight</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>{{ $row->min_weight }} g</td>

                                <td>{{ $row->max_weight }} g</td>
                                ...
                                <td>
                                    <form action="{{ route('admin.master.courier_weight_charge.delete', $row->id) }}" method="POST"
                                        class="float-end">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('admin.master.courier_weight_charge.status', [$row->id, $row->status]) }}"
                                    ...
                                    <a href="{{ route('page.admin.master.courier_weight_charge.edit', $row->id) }}"
