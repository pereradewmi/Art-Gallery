        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="me-4 d-flex">
                    ...
                    <a href="{{ route('page.admin.master.master_publisher.create') }}"
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @foreach($table as $row)
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/master-master_publisher-delete/{{ $row->id }}"
                                        ...
                                        <form
                                            action="/admin/master-master_publisher-status/{{ $row->id }}/{{ $row->status }}"
                                            method="POST" class="float-end">
                                            @csrf
                                            <button
                                        ...
                                        <a href="/admin/master-master_publisher-edit/{{ $row->id }}"
