        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="me-4 d-flex">
                    ...
                    <a href="{{ route('page.admin.master.master_reading_age_group.create') }}"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/admin/master-master_reading_age_group-delete/{{ $row->id }}"
                                    ...
                                    <form
                                        action="/admin/master-master_reading_age_group-status/{{ $row->id }}/{{ $row->status }}"
                                        method="POST" class="float-end">
                                        @csrf
                                    ...
                                    <a href="/admin/master-master_reading_age_group-edit/{{ $row->id }}"
