    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Couriers</h1>
                ...
                <div class="me-4 d-flex">
                    <div class="d-flex align-items-center position-relative my-1 me-3">
                        ...
                        <input type="text" data-kt-table-filter="search"
                            class="form-control form-control-solid w-250px ps-14" placeholder="Search Courier" />
                    </div>
                    <a href="{{ route('page.admin.master.master_courier.create') }}" class="btn btn-primary my-1">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/admin/master-master_courier-delete/{{ $row->id }}" method="POST"
                                        class="float-end">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="/admin/master-master_courier-status/{{ $row->id }}/{{ $row->status }}"
                                    ...
                                    <a href="{{ route('page.admin.master.master_courier.edit', $row->id) }}"
