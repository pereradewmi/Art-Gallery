        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="me-4 d-flex">
                    ...
                    <a href="{{route('page.admin.master.master_author.create')}}" class="btn btn-primary my-1">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/admin/master-master_author-delete/{{$row->id}}" method="POST"
                                        class="float-end">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="/admin/master-master_author-status/{{$row->id}}/{{$row->status}}"
                                    ...
                                    <a href="/admin/master-master_author-edit/{{$row->id}}"
