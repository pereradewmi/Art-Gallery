                ...
                <div class="me-4 d-flex">
                    <div class="d-flex align-items-center position-relative my-1 me-3">
                        ...
                        <input type="text" data-kt-table-filter="search"
                            ...
                            placeholder="Search Courier City Charge" />
                    </div>
                    <a href="{{ route('page.admin.master.courier_city_charge.create') }}" class="btn btn-primary my-1">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Delivery Fee</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.master.courier_city_charge.delete', $row->id) }}"
                                    ...
                                    <form
                                        action="{{ route('admin.master.courier_city_charge.status', [$row->id, $row->status]) }}"
                                        method="POST" class="float-end">
                                        @csrf
                                    ...
                                    <a href="{{ route('page.admin.master.courier_city_charge.edit', $row->id) }}"
