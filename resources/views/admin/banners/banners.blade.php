                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-table-toolbar="base">
                                ...
                                <a type="button" class="btn btn-primary" href="{{route('page.admin.banners.create')}}">
                                ...
                                @foreach ($banners as $key => $banner)
                                    ...
                                    <tr>
                                       ...
                                       <td class="d-flex align-items-center">
                                          ...
                                          <div class="symbol symbol-squre symbol-50px overflow-hidden me-3">
                                             <a href="">
                                                  <div class="symbol-label">
                                                      <img src="{{$banner->image_path}}" alt="" class="w-100" />
                                                    </div>
                                              </a>
                                           </div>
                                        ...
                                        {{-- <td><a href="" class="text-gray-800 text-hover-primary mb-1">{{$user->name}}</a></td> --}}
                                        ...
                                        <td>
                                            ...
                                            <form action="/admin/banner-delete/{{$banner->id}}" method="POST" class="float-end">
                                                @csrf
                                            ...
                                            <a href="/admin/banner-edit/{{$banner->id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 float-end">
