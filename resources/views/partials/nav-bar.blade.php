        ...
        <div class="container">
            <div class="row">
                <div class="header-top-left col-md-8 col-sm-6 col-xs-6">
                    <ul class="listnone">
                        {{-- <li class="dropdown">
                            <a href="{{ route('cart') }}" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-haspopup="true" aria-expanded="false"><i class="fa fa-shopping-cart"
                                    aria-hidden="true"></i> Cart {{ count((array) session('cart')) }} <span
                                    class="caret"></span></a>
                ...
                <div class="header-right col-md-4 col-sm-12 col-xs-12">
                    <div class="pull-right">
                        <ul class="listnone">
                            ...
                            <li><a href="{{ route('customer.login') }}" id="login-box"><i class="fa fa-sign-in"></i> Log In</a></li>
                            <li><a href="{{ route('customer.registration') }}"><i class="fa fa-unlock" aria-hidden="true"></i>Register</a></li>
                            {{-- <li><a href="{{ route('cart') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart {{count((array) session('cart')) }}</a></li> --}}
                            @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">
                                    {{-- <img class="img-circle resize" alt="" src="images/users/3.jpg"> --}}
                                    <span class="myname">Hi, {{ auth()->guard('customers')->user()->first_name
                                        }} </span> <span class="caret"></span></a>

                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('customer.profile') }}">My Profile</a></li>
                                    <!-- <li><a href="{{ route('customer.orders') }}">My Orders</a></li> -->
                                    <li><a href="{{ route('wishlist') }}">Favourites</a></li>
                                    <li><a href="{{ route('orders.my_orders') }}">My Orders</a></li>
                                    <li><a href="{{ route('customer.log-out') }}">Log Out</a></li>
                                </ul>
                            </li>
                             {{-- <li><a href="{{ route('cart') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart {{count((array) session('cart')) }}</a></li> --}}
                            @endif
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12" style="display: flex; flex-direction: row; align-items: center; justify-content: space-between;">
                        <ul class="menu-logo">
                            <li>
                                <a href="{{ route('home') }}"><img src="{{ asset('img/logo.png') }}" alt="logo"
                                        style="width:60px;">
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="menu-links" style="margin-left: 0;">
                            ...
                            <li>
                                <a href="{{ route('books') }}">Arts</a>
                            </li>
                            <li>
                                <a href="{{ route('about-us') }}">About Us</a>
                            </li>
                            <!-- <li>
                                <a href="{{ route('about-us') }}">FAQ</a>
                            </li> -->
                            <li>
                            ...
                            <li style="display:inline; margin-right:50px;  ">
                                <a id="cart-box" href="{{route('cart') }}" >
                                    <div id="cart-box-mobile" class="contact-in-header clearfix" style="border:1px solid #E52D27; border-radius: 30px;padding-inline:15px;">
                                        ...
                                        <img src="{{ asset('img/icons/cart.png') }}" alt="" style="height: 51px;">
                                        <span>

                                            {{session()->get('cartSummary', (object)['cartTotal'=>0, 'cartCount'=>0,])->cartCount ?? 0}} item{{
                                                (session()->get('cartSummary', (object)['cartTotal'=>0, 'cartCount'=>0,])->cartCount ?? 0) > 1 ? 's' : ''
                                            }}
                                            <br>
                                            <strong>Rs. {{session()->get('cartSummary', (object)['cartTotal'=>0, 'cartCount'=>0,])->cartTotal ?? 0}}.00</strong>
                                        </span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li style="" class="contact-box">
                                <a href="{{ route('customer.login') }}">
                                    <div class="contact-in-header clearfix" style="height: 50px; display: flex;  align-items: center; padding-right: 50px;">
                                        ...
                                        <span>
                                            {{ auth()->guard('customers')->user()->first_name ?? 'login'}}
